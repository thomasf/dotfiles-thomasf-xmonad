...
key.setGlobalKey([['C-h', 'j']], function (aEvent, aArg) {
...
key.setGlobalKey([["C-h", "h"]], function (ev, arg) {
    ext.exec("tanything", arg);
}, "view all tabs", true);

key.setGlobalKey(['C-h', 'u'], function (ev, arg) {
...
key.setGlobalKey([['M-x'], ["C-h", 'o', 'o']], function (ev, arg) {
    ext.select(arg, ev);
...
key.setGlobalKey([['C-h', 'r']], function (ev) {
    BrowserReload();
